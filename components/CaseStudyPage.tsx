...
const DataTable: React.FC<DataTableProps> = ({ title, data }) => (
  <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm flex flex-col h-full hover:shadow-md transition-shadow duration-300">
    <div className="px-[1.618rem] py-[1rem] border-b border-gray-100">
    ...
    <div className="flex-grow divide-y divide-gray-50">
        {data.map((item, idx) => (
            <div key={idx} className="flex justify-between items-center px-[1.618rem] py-[1.618rem] text-[1rem] gap-[1.618rem] hover:bg-gray-50/30 transition-colors">
                <span className="text-gray-500 font-medium leading-snug max-w-[160px]">{item.label}</span>
                <span className="font-bold text-[#1a1a1a] text-right text-[1rem] shrink-0">{item.value}</span>
            </div>
        ))}
    </div>
  </div>
...
const SurveyChart: React.FC<SurveyChartProps> = ({ question, data, insight }) => {
    ...
    return (
        <div className="bg-white p-[1.618rem] rounded-2xl border border-gray-100 shadow-sm flex flex-col h-full hover:shadow-md transition-shadow duration-300">
            {/* Header */}
            <h4 className="text-[#1a1a1a] font-medium text-[1rem] mb-[1.618rem] leading-snug font-onest border-b border-gray-50 pb-[1rem] min-h-[3.5rem] flex items-end">
                {question}
            </h4>
            
            <div className="flex flex-col sm:flex-row items-start gap-[1.618rem] mb-[1.618rem]">
                {/* Pie Chart */}
                ...
                <div className="flex flex-col w-full min-w-0 gap-[0.382rem]">
                    {data.map((item, idx) => (
                        <div key={idx} className="flex items-center justify-between text-[0.618rem] w-full py-0.5">
                            <div className="flex items-center gap-[0.618rem] overflow-hidden">
                            ...
                            <span className="font-bold text-[#1a1a1a] pl-[1rem] tabular-nums">{item.value}%</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            {/* Derived Insight */}
            <div className="mt-auto pt-[1rem] border-t border-gray-100">
                <p className="text-[0.618rem] text-gray-500 leading-relaxed">
                    <span className="font-bold text-[#3B82F6] uppercase tracking-wider text-[10px] block mb-[0.382rem]">Key Insight</span>
                    {insight}
                </p>
            </div>
        </div>
      ...
      <div className="flex-grow">
         <div className="max-w-[1400px] mx-auto px-[1.618rem] md:px-[1.618rem] lg:px-[4.236rem] grid grid-cols-1 md:grid-cols-12 gap-[1.618rem] lg:gap-[6.854rem] py-[2.618rem] md:py-[6.854rem] relative">
                  ...
                  <div className="flex flex-col gap-[0.382rem]">
                    {sections.map((section) => {
                        ...
                        <div key={section.id} className="flex flex-col relative">
                           {/* Parent Node */}
                           <div 
                               className="flex items-center gap-[0.382rem] px-[0.382rem] py-[0.382rem] rounded-md hover:bg-gray-100 cursor-pointer transition-colors group"
                               onClick={() => scrollToSection(section.id)}
                           >
                               <div 
                                 className="w-[1rem] h-[1rem] flex items-center justify-center -ml-[0.382rem] text-gray-400 hover:text-gray-700 transition-colors"
                               ...
                               <span className={`text-[1rem] ${isSectionActive ? 'text-black font-semibold' : 'text-gray-700 font-medium group-hover:text-black'}`}>
                                 {section.title}
                               </span>
                           </div>
                           ...
                           {section.children && section.children.length > 0 && expandedSections[section.id] && (
                             <div className="flex flex-col relative ml-[1rem] pl-[1rem] border-l border-gray-200 py-[0.382rem] gap-[0.382rem]">
            ...
            <div className="col-span-1 md:col-span-9 lg:col-span-8 lg:col-start-5 flex flex-col gap-[6.854rem] md:gap-[11.09rem] pb-[6.854rem]">
               ...
               {/* 01 Overview & Story */}
               <section id="overview" className="scroll-mt-[6.854rem]">
                  <span className="block text-[#3B82F6] text-[0.618rem] font-bold tracking-widest uppercase mb-[1rem]">01 — Context</span>
                  
                  {/* Reordered: Product Overview First */}
                  <div className="mb-[2.618rem]">
                     <h2 id="overview-product" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[1.618rem] text-[#1a1a1a]">Product Overview</h2>
                     <div className="bg-[#E8F0FE] p-[1.618rem] md:p-[2.618rem] rounded-2xl">
                        <p className="text-[1rem] leading-relaxed text-[#1a1a1a]">
                            <strong className="text-[#3B82F6]">Seamless Split and Pay</strong> allows you to instantly settle the expenses after the payment. While Google Pay allows you to split expenses within a group but it’s a slow, manual process that happens after the whole payment procedure. The Seamless Split and Pay feature lives directly inside the Scan and Pay flow. It allows the person paying the bill to settle with friends at the exact moment they pay the merchant.
                        </p>
                     </div>
                  </div>

                  {/* Context / The Story Second */}
                  <div className="mb-[4.236rem]">
                    <h2 id="overview-story" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[1.618rem] text-[#1a1a1a]">The Story</h2>
               ...
               <section id="competitive" className="scroll-mt-[6.854rem]">
                  <span className="block text-[#3B82F6] text-[0.618rem] font-bold tracking-widest uppercase mb-[1rem]">02 — Competitive Analysis</span>
                  <h2 id="competitive-landscape" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[1.618rem] text-[#1a1a1a]">Market Landscape</h2>
                  
                  <p className="text-[1rem] text-gray-600 leading-relaxed mb-[2.618rem]">
                  ...
                  <div className="overflow-hidden rounded-2xl border border-gray-200 shadow-sm mb-[4.236rem] bg-white">
                      <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse min-w-[700px]">
                            <thead>
                                <tr className="bg-[#F8FAFC] border-b border-gray-200">
                                    <th className="p-[1.618rem] font-bold text-gray-500 uppercase text-[0.618rem] tracking-widest w-[200px]">Metric</th>
                                    <th className="p-[1.618rem] font-bold text-[#1a1a1a] text-[1rem] w-[25%] font-serif">Google Pay</th>
                                    <th className="p-[1.618rem] font-bold text-[#1a1a1a] text-[1rem] w-[25%] font-serif">PhonePe</th>
                                    <th className="p-[1.618rem] font-bold text-[#1a1a1a] text-[1rem] w-[25%] font-serif">Paytm</th>
                                </tr>
                            </thead>
                            <tbody className="text-[1rem] divide-y divide-gray-100 font-onest">
                                <tr className="group hover:bg-gray-50 transition-colors">
                                    <td className="p-[1.618rem] font-bold text-[#3B82F6]">Market Share <span className="text-gray-400 font-normal block text-[0.618rem] mt-[0.382rem]">(Volume)</span></td>
                                    <td className="p-[1.618rem] font-medium text-gray-700">37%</td>
                                    <td className="p-[1.618rem] font-medium text-gray-900">48.3%</td>
                                    <td className="p-[1.618rem] font-medium text-gray-500">7.8%</td>
                                </tr>
                                <tr className="group hover:bg-gray-50 transition-colors">
                                    <td className="p-[1.618rem] font-bold text-[#3B82F6]">Success Rate</td>
                                    <td className="p-[1.618rem] text-gray-700 font-medium">99%</td>
                                    <td className="p-[1.618rem] font-bold text-green-600">99.2% <span className="text-[10px] uppercase tracking-wide opacity-80 block mt-[0.382rem]">Highest</span></td>
                                    <td className="p-[1.618rem] font-bold text-red-500">98.5% <span className="text-[10px] uppercase tracking-wide opacity-80 block mt-[0.382rem]">Lowest</span></td>
                                </tr>
                                <tr className="group hover:bg-gray-50 transition-colors">
                                    <td className="p-[1.618rem] font-bold text-[#3B82F6]">Split Navigation</td>
                                    <td className="p-[1.618rem] text-gray-700 leading-relaxed">Inside the <span className="font-bold">"Pay anyone"</span> button</td>
                                    <td className="p-[1.618rem] text-gray-700 leading-relaxed">Inside <span className="font-bold">"To Mobile Number"</span></td>
                                    <td className="p-[1.618rem] text-gray-700 leading-relaxed">Inside the <span className="font-bold">history</span></td>
                                </tr>
                                <tr className="group hover:bg-gray-50 transition-colors">
                                    <td className="p-[1.618rem] font-bold text-[#3B82F6]">Split Method</td>
                                    <td className="p-[1.618rem] text-gray-700 leading-relaxed">Not after the payment + history</td>
                                    <td className="p-[1.618rem] text-gray-700 leading-relaxed">After payment + history</td>
                                    <td className="p-[1.618rem] text-gray-700 leading-relaxed">History + link to message</td>
                                </tr>
                                <tr className="group hover:bg-gray-50 transition-colors">
                                    <td className="p-[1.618rem] font-bold text-[#3B82F6]">Group Creation</td>
                                    <td className="p-[1.618rem]">
                                        <div className="flex flex-col gap-[0.382rem]">
                                             <span className="font-bold text-gray-900">Yes</span>
                                             <span className="text-red-500 text-[0.618rem] font-bold uppercase tracking-wide">Mandatory</span>
                                        </div>
                                    </td>
                                    <td className="p-[1.618rem]">
                                        <div className="flex flex-col gap-[0.382rem]">
                                ...
                                <tr className="group hover:bg-gray-50 transition-colors">
                                    <td className="p-[1.618rem] font-bold text-[#3B82F6]">Math</td>
                                    <td className="p-[1.618rem] text-gray-700">Custom <span className="text-green-600 font-bold text-[0.618rem] uppercase block mt-[0.382rem]">(Advanced)</span></td>
                                    <td className="p-[1.618rem] text-gray-700">Custom</td>
                                    <td className="p-[1.618rem] text-gray-700">Custom</td>
                                </tr>
                            </tbody>
                        </table>
                  ...
                  <div className="mb-[4.236rem]">
                      <h3 id="competitive-takeaways" className="scroll-mt-[6.854rem] text-[1.618rem] md:text-[2.618rem] font-serif font-normal text-[#1a1a1a] mb-[1.618rem]">UX Takeaways</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-[1rem] md:gap-[1.618rem]">
                            {[
                                { title: "Groups Fatigue", desc: "Mandatory group creation for every split and pay method." },
                                { title: "Post Memory-Tax", desc: "Have to remember the split after payment and then mandatory group creation." },
                                { title: "Flow vs Feature", desc: "I’m not adding a new feature rather I’m just modifying the existing feature to improve the current UX. I will make sure the user can split on the moment he pays the merchant." },
                                { title: "Public Chat", desc: "Making an announcement in the group for payment can not be good user experience for everyone, rather sending them personal message for payment instantly after the payment can create a good user experience." }
                            ].map((item, i) => (
                                <div key={i} className="bg-white p-[1.618rem] rounded-3xl border border-gray-200 shadow-sm hover:shadow-md hover:bg-gray-50 transition-all duration-300 flex flex-col justify-start">
                                    <div className="flex items-center gap-[0.618rem] mb-[1rem]">
                                        <span className="text-[0.618rem] font-bold text-[#3B82F6] bg-blue-50 px-[0.382rem] py-0.5 rounded-md">0{i + 1}</span>
                                        <h4 className="font-bold text-[#1a1a1a] text-[1.618rem]">{item.title}</h4>
                                    </div>
                                    <p className="text-[1rem] text-gray-500 leading-relaxed font-onest">{item.desc}</p>
                                </div>
                            ))}
                      </div>
                  </div>
               ...
               {/* 03 Research */}
               <section id="research" className="scroll-mt-[6.854rem]">
                  <span className="block text-[#3B82F6] text-[0.618rem] font-bold tracking-widest uppercase mb-[1rem]">03 — Research</span>
                  
                  {/* Quantitative Research */}
                  <div className="mb-[6.854rem]">
                     <h2 id="research-quantitative" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[1.618rem] text-[#1a1a1a]">Quantitative Research</h2>
                     <p className="text-[1rem] text-gray-600 mb-[1.618rem] leading-relaxed">
                     ...
                     <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm mb-[4.236rem]">
                        <div className="bg-white px-[1.618rem] py-[1rem] border-b border-gray-100 hidden md:grid md:grid-cols-[1.5fr_1fr_2fr] gap-[1rem]">
                        ...
                        <div className="divide-y divide-gray-100/60">
                            {[
                                ...
                                <div key={i} className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_2fr] gap-[1rem] md:gap-[1rem] px-[1.618rem] py-[1.618rem] md:py-[1.618rem] text-[1rem] items-center hover:bg-gray-50/30 transition-colors">
                                    <span className="text-gray-700 font-medium md:text-[1rem]">{row.cat}</span>
                                    <span className="font-bold text-[#1a1a1a] text-[1rem]">{row.pct}</span>
                     ...
                     <p className="text-[1rem] text-gray-600 leading-relaxed mb-[1.618rem] p-[1.618rem] bg-blue-50 border-l-4 border-blue-500 rounded-r-lg">
                     ...
                     {/* Demographics Grid */}
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1.618rem] mb-[4.236rem]">
                        <DataTable 
                            title="Professions"
                            data={[
                     ...
                     <div className="mt-[2.618rem] mb-[2.618rem] p-[1.618rem] bg-[#F0F9FF] border-l-4 border-[#3B82F6] rounded-r-xl">
                        <h4 className="font-bold text-[#3B82F6] mb-[1rem] uppercase tracking-widest text-[0.618rem]">Key Insights</h4>
                        <div className="space-y-4 text-[#1a1a1a] leading-relaxed text-[1rem]">
                     ...
                     <div className="mb-[1.618rem]">
                        <h3 className="text-[1.618rem] font-serif mb-[1.618rem] text-[#1a1a1a]">Who uses Google Pay?</h3>
                        <div className="bg-white p-[1.618rem] md:p-[1.618rem] rounded-xl border border-gray-200 shadow-sm relative overflow-hidden">
                             <div className="absolute top-0 left-0 w-[0.382rem] h-full bg-[#3B82F6]"></div>
                             <p className="text-[1rem] text-gray-700 leading-relaxed font-medium">
                  ...
                  <div>
                    <h2 id="research-qualitative" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[1.618rem] text-[#1a1a1a]">Qualitative Research</h2>
                    
                    {/* User Survey Insights */}
                    <div className="mb-[4.236rem]">
                        <h3 className="text-[1.618rem] font-serif mb-[1.618rem] text-[#1a1a1a]">User Survey Insights (20 Responses)</h3>
                        <p className="text-[1rem] text-gray-600 mb-[1.618rem] leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-[1.618rem] lg:gap-[1.618rem]">
                    ...
                    <h3 className="text-[1.618rem] font-serif mb-[1.618rem]">User Persona</h3>
                    <div className="bg-[#E8F0FE] p-[1.618rem] md:p-[2.618rem] rounded-2xl flex flex-col md:flex-row gap-[2.618rem] items-start">
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row md:justify-between md:items-baseline mb-[1rem]">
                                    <h4 className="text-[2.618rem] font-bold text-[#1a1a1a]">Sumedh</h4>
                                    <span className="bg-[#FDE047] px-[0.618rem] py-[0.382rem] text-[0.618rem] font-bold uppercase tracking-wide rounded-full mt-[0.382rem] md:mt-0 self-start">Archetype</span>
                            </div>
                            <ul className="text-[1rem] text-gray-600 mb-[1.618rem] space-y-1">
                                <li>• Age: 25</li>
                            ...
                            <div className="space-y-4 text-gray-700 leading-relaxed">
                                ...
                                <div className="flex gap-[0.618rem] flex-wrap">
                                    {['Decent', 'Shy', 'Helpful', 'Tech Savvy', 'Travel Enthusiast'].map(tag => (
                                        <span key={tag} className="px-[0.618rem] py-[0.382rem] bg-white border border-blue-200 rounded-full text-[0.618rem] font-bold text-blue-600">{tag}</span>
                                    ))}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mt-[4.236rem] border-t border-gray-200 pt-[4.236rem]">
                        <div className="flex flex-col md:flex-row md:items-baseline justify-between mb-[1.618rem] gap-[1rem]">
                            <h3 className="text-[1.618rem] font-serif text-[#1a1a1a]">Sumedh's Journey (Current State)</h3>
                        ...
                        <div className="border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm overflow-x-auto">
                           <div className="min-w-[900px] grid grid-cols-[160px_1fr_1fr_1fr_1fr_1fr] divide-x divide-gray-100">
                                ...
                                <div className="bg-gray-50/50 flex flex-col font-onest">
                                    <div className="h-14 flex items-center px-[1rem] font-bold text-gray-400 text-[10px] uppercase tracking-widest border-b border-gray-100 bg-gray-100/50">Phase</div>
                                    <div className="h-32 px-[1rem] py-[1rem] font-bold text-[#1a1a1a] text-[0.618rem] uppercase tracking-widest flex items-center border-b border-gray-100">Actions</div>
                                    <div className="h-32 px-[1rem] py-[1rem] font-bold text-[#1a1a1a] text-[0.618rem] uppercase tracking-widest flex items-center border-b border-gray-100">Thinking</div>
                                    <div className="h-24 px-[1rem] py-[1rem] font-bold text-[#1a1a1a] text-[0.618rem] uppercase tracking-widest flex items-center">Feeling</div>
                                </div>
                                
                                {/* Data Columns */}
                                {journeyPhases.map((phase, idx) => (
                                    <div key={idx} className="flex flex-col font-onest hover:bg-gray-50/30 transition-colors">
                                        <div className="h-14 flex items-center px-[1rem] font-bold text-[#1a1a1a] text-[1rem] border-b border-gray-100 bg-gray-50/30">
                                            {phase.phase}
                                        </div>
                                        <div className="h-32 px-[1rem] py-[1.618rem] text-[1rem] text-gray-600 leading-relaxed border-b border-gray-100">
                                            {phase.action}
                                        </div>
                                        <div className="h-32 px-[1rem] py-[1.618rem] text-[1rem] text-gray-500 italic leading-relaxed border-b border-gray-100">
                                            "{phase.thinking}"
                                        </div>
                                        <div className="h-24 px-[1rem] flex items-center gap-[0.618rem]">
                                            <span className="text-[1.618rem]" role="img" aria-label={phase.feelingLabel}>{phase.feeling}</span>
                                            <span className="text-[0.618rem] font-medium text-gray-400 uppercase tracking-wide">{phase.feelingLabel}</span>
                                        </div>
                                    </div>
                                ))}
                           </div>
               ...
               <section id="define" className="scroll-mt-[6.854rem]">
                   <span className="block text-[#3B82F6] text-[0.618rem] font-bold tracking-widest uppercase mb-[1rem]">04 — Define</span>
                   
                   {/* Design Process Section */}
                   <div className="mb-[4.236rem]">
                        <h2 id="define-process" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[1.618rem] text-[#1a1a1a]">Design Process</h2>
                        <p className="text-[1rem] text-gray-600 mb-[2.618rem] leading-relaxed">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-[2.618rem] gap-x-[1rem]">
                            {[
                                ...
                                <div key={idx} className="flex flex-col relative group">
                                    {/* Step Number & Line */}
                                    <div className="flex items-center gap-[0.618rem] mb-[1rem]">
                                        <div className="w-8 h-8 rounded-full bg-blue-50 text-blue-600 font-bold flex items-center justify-center text-[1rem] border border-blue-100 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
                                            {idx + 1}
                                        </div>
                                    ...
                                    {/* Title */}
                                    <h4 className="font-bold text-[#1a1a1a] text-[1.618rem] mb-[1rem]">{step.title}</h4>
                                    
                                    {/* Items */}
                                    <ul className="space-y-2">
                                        {step.items.map((item, i) => (
                                            <li key={i} className="text-[1rem] text-gray-500 font-medium flex items-center gap-[0.382rem]">
                                                <span className="w-[0.382rem] h-[0.382rem] rounded-full bg-gray-300"></span>
                                                {item}
                                            </li>
                                        ))}
                                    </ul>
                   ...
                   <h2 id="define-problem" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[2.618rem] text-[#1a1a1a]">Problem vs Solution</h2>
                   
                   {/* The Problems Section */}
                   <div className="mb-[4.236rem]">
                       <h3 className="text-[1.618rem] font-bold text-[#1a1a1a] mb-[1.618rem]">The Problems</h3>
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-[1.618rem]">
                           {defineData.map((item, i) => (
                               <div key={i} className="bg-white p-[1.618rem] rounded-xl border border-red-100 shadow-sm hover:border-red-200 transition-colors">
                                   <h4 className="font-bold text-[1.618rem] text-[#1a1a1a] mb-[0.618rem]">{item.problemTitle}</h4>
                                   <p className="text-gray-600 text-[1rem] leading-relaxed">{item.problemDesc}</p>
                               </div>
                           ))}
                       </div>
                   </div>
                   ...
                   <div className="mb-[4.236rem]">
                       <h3 className="text-[1.618rem] font-bold text-[#1a1a1a] mb-[1.618rem]">The Solutions</h3>
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-[1.618rem]">
                           {defineData.map((item, i) => (
                               <div key={i} className="bg-white p-[1.618rem] rounded-xl border border-green-100 shadow-sm hover:border-green-200 transition-colors bg-green-50/20 flex flex-col">
                                   <h4 className="font-bold text-[1.618rem] text-[#1a1a1a] mb-[0.618rem]">{item.solutionTitle}</h4>
                                   <p className="text-gray-600 text-[1rem] leading-relaxed mb-[1rem]">{item.solutionDesc}</p>
                               </div>
                           ))}
                       </div>
                   </div>
...
<section id="ideate" className="scroll-mt-[6.854rem]">
                   <span className="block text-[#3B82F6] text-[0.618rem] font-bold tracking-widest uppercase mb-[1rem]">05 — User Flow</span>
                   
                    <div className="mb-[2.618rem]">
                         {/* 1st - Scan and Pay Flow */}
                        <h3 id="ideate-scan" className="scroll-mt-[6.854rem] text-[1.618rem] font-bold text-[#1a1a1a] mb-[1.618rem]">User Flow of Scan and Pay</h3>
                        <div 
                        ...
                        {/* 2nd - Existing Flow */}
                        <h3 id="ideate-existing" className="scroll-mt-[6.854rem] text-[1.618rem] font-bold text-[#1a1a1a] mb-[1.618rem]">Existing Split expense method</h3>
                        <div 
                        ...
                        <p className="text-gray-600 leading-relaxed font-onest mb-[2.618rem] max-w-2xl px-[0.382rem]">
                        ...
                        <h3 id="ideate-new" className="scroll-mt-[6.854rem] text-[1.618rem] font-bold text-[#1a1a1a] mb-[1.618rem]">New Split and Pay method inside the Scan and pay flow</h3>
                        <div 
                   ...
                   <p className="text-gray-600 leading-relaxed mb-[1.618rem]">
                     (This section is under construction)
                   </p>
               </section>

               {/* 06 Design - Placeholder to satisfy navigation */}
               <section id="design" className="scroll-mt-[6.854rem]">
                   <span className="block text-[#3B82F6] text-[0.618rem] font-bold tracking-widest uppercase mb-[1rem]">06 — Design</span>
                   <h2 id="design-intro" className="scroll-mt-[6.854rem] text-[2.618rem] md:text-[4.236rem] font-serif font-normal mb-[1.618rem] text-[#1a1a1a]">Design</h2>
                   <p className="text-gray-600 leading-relaxed mb-[2.618rem]">
                   ...
                   <div className="flex flex-col gap-[2.618rem] md:gap-[4.236rem]">
      ...
      {selectedImg && (
        <div 
          className="fixed inset-0 z-[100] flex items-center justify-center p-[1rem] md:p-[2.618rem] animate-fade-in"
